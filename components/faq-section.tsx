...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer: "本商品では、もやしやキャベツを一緒に炊飯器に入れるパターンと、レンジで少し温めたもやしやキャベツを後に入れるパターンの二通りの作り方を推奨しています。そのため、炊飯器に一緒に入れてもとても美味しく召し上がることができます。"
  },
  {
    question: "ニンニクやアブラの匂いが炊飯器に残らないか心配です。",
    answer: "ニンニクの風味や豚の旨味が強い商品のため、炊飯後に内釜やパッキンに匂いが残る場合がございます。ご使用後はなるべく早めに釜をアルコールを用いると匂いが軽減されます。どうしても匂いが気になる場合は、さらに内釜に水2合程度を入れて「早炊き」を一度行っていただくと匂いが軽減されます。"
  },
  {
    question: "ニンニクや背脂の量は自分で調節できますか？",
    answer: "炊き込みご飯の素にすでにニンニクと背脂が配合されているため、減らすことはできません。しかし、「もっとパンチが欲しい！」という方は、炊きあがり後に「刻み生ニンニク」や、市販の「ラード（アブラ）」、さらには「卵黄」をトッピングしていただくことで、より凶暴でクセになる味わいにカスタマイズ可能です。"
  },
  {
